...
def attack(char_name: str, char_class: str) -> str:
    """Определяет урон противнику в зависимости от типа война."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет уровень защиты в зависимости от типа война."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определяет специальные умения в зависимости от типа война."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывает выбранного война и команды, которые он может выполнять."""
    if char_class == 'warrior':
